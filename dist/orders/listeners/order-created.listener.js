...
let OrderCreatedListener = class OrderCreatedListener {
    schedulerService;
...
], OrderCreatedListener.prototype, "handleOrderCreatedEvent", null);
exports.OrderCreatedListener = OrderCreatedListener = __decorate([
